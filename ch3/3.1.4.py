...
def main():
    ...
    c = np.linalg.lstsq(x_train, y_train, rcond=-1)[0] # call lstsq on training data, rcond=-1 uses machine precision for small singular values of a
    ...
    print(x_test @ c) # use c computed by training data to compute coefficients for test data
