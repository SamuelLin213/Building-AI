        ...
        for port3 in range(1, 5):
            for port4 in range(1, 5):
                for port5 in range(1, 5):
                    ...
                    # Modify this if statement to check if the route is valid; checks if num is in route array
                    if(0 in route and 1 in route and 2 in route and 3 in route and 4 in route):
                        ...
                        emissions = distance * co2 # calculate total emissions using this route
